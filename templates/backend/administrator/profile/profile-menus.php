                ...
                <div class="mxlms-panel-body">
                    <div class="mxlms-page-title-area">
                        ...
                        <span class="mxlms-page-title">
                            <?php esc_html_e('Profile Manager', BaseController::$text_domain); ?>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="mxlms-col">
            <div class="mxlms-panel">
                <div class="mxlms-panel-title">
                    <?php esc_html_e('Select a profile option', BaseController::$text_domain); ?>
                </div>
                <div class="mxlms-panel-body">
                    <div class="mxlms-row">
                        <div class="mxlms-col-md-6 mxlms-settings-container mxlms-border-right-for-settings-types">
                            <p class="mxlms-settings-type-title">
                                <i class="las la-user-circle"></i> <?php esc_html_e('Update Profile', BaseController::$text_domain); ?>
                            </p>
                        ...
                        <div class="mxlms-col-md-6 mxlms-settings-container">
                            <p class="mxlms-settings-type-title">
                                <i class="las la-fingerprint"></i> <?php esc_html_e('Change Password', BaseController::$text_domain); ?>
                            </p>
                            <p class="mxlms-settings-type-description">
                                <?php esc_html_e('Use this option for updating your password.', BaseController::$text_domain); ?>
                            </p>
                            <a href="javascript:void(0)" onclick="present_right_modal( 'profile/update-password', '<?php esc_html_e('Change Password', BaseController::$text_domain); ?>' )" class="mxlms-text-decoration-none">
                                <?php esc_html_e('Change Password', BaseController::$text_domain); ?>
                                <i class="las la-arrow-right"></i>
                            </a>
                        </div>
                    </div>
