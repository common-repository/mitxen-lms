...
<input type="hidden" name="video_provider" value="vimeo">
<div class="mxlms-form-group">
  <label for="video_url"><?php esc_html_e('Vimeo Video URL', BaseController::$text_domain); ?></label>
  <input type="text" name="video_url" class="form-control" id="video_url" aria-describedby="video_url" placeholder="<?php esc_html_e('Provide Vimeo video URL', BaseController::$text_domain); ?>" value="<?php echo esc_url($video_url); ?>">
</div>
...
<br>
<div class="mxlms-form-group">
  <label for="duration"><?php esc_html_e('Vimeo Video Duration', BaseController::$text_domain); ?></label>
