...
$task                    = Mxlms\base\AjaxPosts::$param1;
$id                      = Mxlms\base\AjaxPosts::$param2;
$submission_hook         = Mxlms\base\AjaxPosts::$param3;
$section_to_be_displayed = Mxlms\base\AjaxPosts::$param4;
$section_container      = Mxlms\base\AjaxPosts::$param5;
$parameter_to_return_1  = Mxlms\base\AjaxPosts::$param6;
$parameter_to_return_2  = Mxlms\base\AjaxPosts::$param7;
$parameter_to_return_3  = Mxlms\base\AjaxPosts::$param8;
?>
...
<form action="<?php echo admin_url(); ?>admin-post.php" method="post" class='mxlms-form confirmation-form' enctype='multipart/form-data' autocomplete="off">
    <input type="hidden" name="action" value="<?php echo esc_attr( \Mxlms\base\BaseController::$plugin_id . '_' . esc_attr($submission_hook) ); ?>">
    ...
    <label for="warning" class="mxlms-confirmation-modal-label"><?php esc_html_e('Are you sure, You want to do this?', \Mxlms\base\BaseController::$text_domain) ?></label><br>
