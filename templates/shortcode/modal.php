...
<script>
    ...
    function present_modal_page(page, header_title, param1, param2, param3) {
        jQuery('#ajax-modal-page .modal-body').html('<?php esc_html_e('Please Wait', BaseController::$text_domain); ?>');
        jQuery('.modal-title').html(header_title);
        jQuery('#ajax-modal-page .modal-body').block({
            message: null,
            overlayCSS: {
                backgroundColor: '#ffffff'
            }
        });
        jQuery('#ajax-modal-page').modal('show', {
            backdrop: 'true'
        });
    ...
    function confirmation_for_deletion(page, header_title, param1, param2, param3, param4, param5, param6, param7, param8, param9) {
        jQuery('#confirm-action-title').html(header_title);
        jQuery('#confirm-action').modal('show', {
            backdrop: 'true'
        });
...
<div class="modal fade bd-example-modal-lg" id="ajax-modal-page" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
