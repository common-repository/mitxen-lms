...
<script>
    ...
    function confirmation_for_deletion(header_title, param1, param2, param3, param4, param5, param6, param7, param8, param9) {
        ...
        closeModal();
        jQuery("#confirmation-modal .mxlms-custom-modal-body").html('<?php esc_html_e('Please Wait...', BaseController::$text_domain); ?>');
    ...
    function confirmation_for_updating(header_title, param1, param2, param3, param4, param5, param6, param7, param8, param9) {
        closeModal();
        jQuery("#confirmation-for-update-modal .mxlms-custom-modal-body").html('<?php esc_html_e('Please Wait...', BaseController::$text_domain); ?>');
